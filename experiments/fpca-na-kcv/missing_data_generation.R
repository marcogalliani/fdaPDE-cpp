...
setwd("/Users/marcogalliani/Projects/fdaPDE-cpp/experiments/fpca-na-kcv")
library(fdaPDE)
library(femR)
...
mesh <- unit_square.mesh(100,meshdir)
...
locations <- unit_square.locs(100,datadir)
...
writeMM(as(noisy_data, "CsparseMatrix"), paste(datadir,"y_complete.mtx",sep=""))


plot_eigenfunction(test_functions[,3],locations)
plot_eigenfunction(loadings[[3]],locations)


plot_eigenfunction(loadings[[3]],locations)

plot_eigenfunction(center[[1]],locations)
