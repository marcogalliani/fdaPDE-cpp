#ifndef SP_SMOOTHING_H
#define SP_SMOOTHING_H
...
// solver factory
template <typename BilinearForm_, typename LinearForm_> struct sp_smoothing {
using solver_t = internals::sp_smoothing;
private:
...
public:
    sp_smoothing(const BilinearForm_& bilinear_form, const LinearForm_& linear_form) :
